...
- Lehrpersonen bewerten wissenschaftliche Informationen häufig aus zweiter Hand, d.h. sie bewerten nicht den Wahrheitsgehalt dieser Informationen, sondern ihre Glaub- und Vertrauenswürdigkeit (z.B. Bromme et al., 2010; Merk & Rosman, 2019).
<br> 
<br>
- Vertrauen in Wissenschaft als zentraler Prädiktor, inwieweit Lehrpersonen wissenschaftliche Evidenz positiv evaluieren und berücksichtigen (Bromme et al.,2022; Hendriks et al., 2016)
<br>
<br>
...
* (angehende) Lehrpersonen vertrauen anderen Lehrpersonen mehr als Wissenschaftler:innen
  ...
  + vor allem fehlende Integrität und Benevolenz als Gründe für Misstrauen in Bildungswissenschaftler:innen (Rosman & Merk, 2021)
  + höheres Vertrauen in Lehrpersonen als Wissenschaftler:innen, wenn es um die Suche nach praktischem Rat geht (Hendriks et al., 2021)
<br>
<br>
...
.content-box-phgreen[Barriere für die Realisierung evidenzinformierte Praxis:  <br>
anekdotische Evidenz, die wissenschaftlich nicht haltbar ist, verbreitet sich im Alltag und führt zu ineffektiver oder gar dysfunktionaler Praxis]
...
* .phgreenlight[Confirmation Bias im Bildungskontext] bisher wenig systematisch erforscht 
...
.content-box-phgreen[Barriere für die Realisierung evidenzinformierte Praxis: 
einseitige Bezugnahme auf wissenschaftliche Evidenz]
...
H<sub>1</sub>: Wenn Lehrpersonen Aussagen zu bestimmten Themen aus der Bildungswissenschaft präsentiert werden, zeigen sie .phgreenlight[mehr Vertrauen in diese Aussagen, wenn diese angeblich von einem anderen Lehrer stammen (anekdotische Evidenz)], als einer wissenschaftlichen Studie (wissenschaftliche Evidenz).
...
```{css slide-number-off-2, echo=F, warning=FALSE, message=FALSE}
.remark-slide-number {
  display: none;
}
```
