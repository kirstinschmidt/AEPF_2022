...
* Vertrauen in wissenschaftliche Evidenz `r fontawesome::fa_i(name = "check")`
  * Informationsquelle `r fontawesome::fa_i(name = "list")`
  * Confirmation Bias `r fontawesome::fa_i(name = "eye-slash")`
...
---
## .phgreenlight[Vertrauen in wissenschaftliche Evidenz `r fontawesome::fa_i(name = "check")`]
...
### .phgreenlight[Informationsquellen `r fontawesome::fa_i(name = "list")`]

* Lehrpersonen können auf eine Vielzahl an unterschiedlichen Informationsquellen zurückgreifen, um ihre Praxis zu informieren &rarr; Informationsquellen reichen von anekdotischer Evidenz (z.B. eigene Lehrerfahrung, Ratschläge von Kolleg:innen) bis wissenschaftlicher Evidenz .em06[(z.B.Buehl & Fives, 2009)]
<br>
...
* (angehende) Lehrpersonen vertrauen anderen Lehrpersonen mehr als Wissenschaftler:innen
  + XX Domänen
  + XX konkrete Aussagen
  + XX praktischen Bezug
<br>
<br>

.phgreenlight[ &rarr; Barriere für die Realisierung evidenzinformierte Praxis:  <br>
alltägliche Konzepte / Vorstellungen, die wissenschaftlich nicht haltbar sind, verbreiten sich im Alltag und führen zu ineffektiver oder gar dysfunktionaler Praxis]

---

### .phgreenlight[Confirmation Bias `r fontawesome::fa_i(name = "eye-slash")`]

* .phgreenlight[Confirmation Bias = eigene Überzeugungen beeinflussen Informationssuche und -interpretation]
...
<br>
<br>
* Confirmation Bias im Bildungskontext bisher wenig systematisch erforscht und primär mit Blick auf Evaluation erster Hand
