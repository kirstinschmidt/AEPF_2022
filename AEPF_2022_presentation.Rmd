...
* zahlreiche Barrieren, die Lehrpersonen evidenzinformiertes Handeln erschweren 
  * zeitliche Ressourcen
  * Überzeugungssysteme z.B. negative Überzeugungen bezüglich der praktischen Anwendbarkeit
  * .phgreenlight[__kognitive Fähigkeiten__] <br>
  .em06[(z.B. Brown et al., 2022; van Schaik et al., 2018)]
...
- Lehrpersonen bewerten wissenschaftliche Evidenz häufig aus zweiter Hand, d.h. sie bewerten nicht ihren Wahrheitsgehalt, sondern ihre Glaub- und Vertrauenswürdigkeit. .em06[(z.B. Bromme et al., 2010; Merk & Rosman, 2019)]
<br> 
<br>
...
* .phgreenlight[__(angehende) Lehrpersonen vertrauen anderen Lehrpersonen mehr als Wissenschaftler:innen__]
  ...
  + höheres Vertrauen in Lehrpersonen als Wissenschaftler:innen, wenn es um praktischen Rat geht .em06[(Hendriks et al., 2021)]
<br>
<br>
...
.content-box-phgreen[Einseitiger oder fehlender Bezug zu wissenschaftliche Evidenz  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br> kann eine angemessene Realisierung evidenzinformierter Praxis erschweren oder sogar verhindern &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;]
...
H<sub>1</sub>: Wenn Lehrpersonen bestimmte bildungswissenschaftlichen Aussagen präsentiert werden, zeigen sie .phgreenlight[mehr Vertrauen in diese Aussagen, wenn sie angeblich von einem anderen Lehrperson stammen (anekdotische Evidenz)], als einer wissenschaftlichen Studie (wissenschaftliche Evidenz).
...
* .phgreenlight[im Gegensatz zu bisherigen Studien, vertrauen die befragten Lehrpersonen stärker in wissenschaftliche Evidenz als in anekdotische Evidenz] <br>
* mögliche Erklärungen für diese unterschiedlichen Ergebnisse: 
  ...
  * Beeinflussung durch Publikationsorgan (wissenschaftliche Zeitschrift vs. Lehrerblog) <br> &rarr; Informationen aus sozialen Medien werden im Vergleich zu wissenschaftlicher und anektodischer Evidenz weniger vertrauenswürdig eingeschätzt (Braten)
<br>
<br>
<br> 
...
* .phgreenlight[im Einklang mit bisherigen Studien, weisen die befragten Lehrpersonen einen starken Confirmation Bias auf] <br> 
  ...
  * Implikationen für weitere Studien: 
      + Berücksichtigung der Stärke der Überzeugungen
